...
const CHARACTER_CONFIGS := {
	...
	"warrior_spearman": {
		...
		"skin_description": "Real lancer sprites with charge thrust and piercing spear attacks",
		...
		"attack_hit_frame": 2,
		"attack_type": "melee",
		"kick_attack_type": "charge_thrust",
		"max_health": 112,
		"speed": 272.0,
		"jump_velocity": -585.0,
		"attack_damage": 18,
		...
		"kick_cooldown": 2.2,
		"kick_hit_frame": 1,
		"kick_knockback_force": 420.0,
		"charge_thrust_distance": 180.0,
		"charge_thrust_duration": 0.28,
		"charge_thrust_first_hit_multiplier": 1.5,
		"charge_thrust_max_charge_time": 1.2,
		"charge_thrust_charged_distance": 280.0,
		"charge_thrust_charged_duration": 0.35,
		"charge_thrust_charged_damage_multiplier": 1.8,
